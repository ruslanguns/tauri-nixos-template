  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        mingwBuildPackages = with pkgs.pkgsCross.mingwW64.buildPackages; [ gcc binutils ];
        mingwRuntimePackages = with pkgs.pkgsCross.mingwW64.windows; [ mingw_w64_pthreads pthreads ];
